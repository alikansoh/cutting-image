    ...
    <>
      <style>{`
        :root {
          ...
          /* Olive / green accents (from the Hero) */
          --olive:      #6B7A3A;
          --olive-hi:   #8A9E4A;
          --olive-lo:   #47531F;
        }
        ...
        .sv-card:hover .sv-icon-wrap {
          ...
          /* add subtle olive glow alongside gold */
          box-shadow: 0 0 0 6px rgba(201,162,39,0.06), 0 0 0 10px rgba(107,122,58,0.03), 0 8px 24px rgba(201,162,39,0.12);
        ...
        .sv-badge {
          ...
          /* blend gold + olive subtly so the badge picks up the green accent */
          background: linear-gradient(90deg, rgba(201,162,39,0.08) 0%, rgba(107,122,58,0.06) 100%);
        ...
        .sv-badge::before { content: ''; width: 14px; height: 1px; background: var(--olive-hi); opacity: 0.8; }
        .sv-card:hover .sv-badge { background: linear-gradient(90deg, rgba(201,162,39,0.14), rgba(107,122,58,0.12)); border-color: rgba(107,122,58,0.28); }
