  ...
  return (
    <>
      <style>{`
        :root {
          --nav-h:   72px;
          --gold:    #C9A227; --gold-lt: #F0D878; --gold-dk: #6B4F16;
          --olive:    #6B7A3A; --olive-hi: #8A9E4A; --olive-lo: #47531F;

          /* Cream palette (used for the page background to match other components) */
          --ink:     #F5F1E8; /* page background (was dark) */
          --ink2:    #EDE7D6; /* panels / light surfaces */
          --ink3:    #EFEAD9; /* card surfaces */
          --warm:    #1C1C1C; /* primary text color on cream */
        ...
        .g-cursor{position:fixed;z-index:9000;pointer-events:none;top:0;left:0;width:52px;height:52px;border-radius:50%;border:1px solid var(--olive-hi);display:flex;align-items:center;justify-content:center;background:rgba(138,158,74,0.06);backdrop-filter:blur(4px);transform:translate(-50%,-50%);transition:opacity 0.25s}
        .g-cursor svg{color:var(--olive-hi)}
        ...
        .g-ticker-gem{width:4px;height:4px;background:var(--olive-hi);transform:rotate(45deg);flex-shrink:0}

        .g-side-txt{position:fixed;left:20px;top:50%;transform:translateY(-50%) rotate(-90deg);transform-origin:center;font-family:'Bebas Neue',sans-serif;font-size:0.68rem;letter-spacing:0.38em;color:rgba(201,162,39,0.22);white-space:nowrap;pointer-events:none;z-index:3}
        ...
        .g-eyebrow-tag{font-size:9.5px;font-weight:600;letter-spacing:0.3em;text-transform:uppercase;color:var(--olive-hi)}
        .g-rule{height:1px;width:64px;background:linear-gradient(90deg,var(--olive-hi),var(--gold));transform-origin:left;transform:scaleX(0)}
        ...
        .g-hd-line.gold{background:linear-gradient(110deg,var(--olive-lo) 0%,var(--gold-dk) 10%,var(--gold) 35%,var(--gold-lt) 55%,var(--gold) 75%,var(--olive-hi) 100%);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}
        ...
        .g-stat-val{display:block;font-family:'Bebas Neue',sans-serif;font-size:clamp(2rem,3.4vw,3rem);line-height:1;background:linear-gradient(120deg,var(--olive-hi),var(--gold));-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent}
        ...
        .g-filter::after{content:'';position:absolute;bottom:0;left:22px;right:22px;height:1px;background:linear-gradient(90deg,var(--olive-hi),var(--gold));transform:scaleX(0);transform-origin:left;transition:transform 0.4s var(--ease)}
        .g-filter:hover{color:var(--warm)}
        .g-filter.active{color:var(--olive-hi)}
        ...
        .g-card-label{font-family:'Bebas Neue',sans-serif;font-size:1.2rem;letter-spacing:0.07em;color:#ffffff;line-height:1.1} /* changed to white */
        .g-card-tag{font-size:8px;letter-spacing:0.22em;text-transform:uppercase;color:var(--olive-hi);margin-top:3px;display:block}
        ...
        .g-card-idx{position:absolute;top:12px;right:14px;z-index:4;font-family:'Bebas Neue',sans-serif;font-size:0.72rem;letter-spacing:0.2em;color:rgba(138,158,74,0.45);opacity:0;transition:opacity 0.35s ease}
        .g-card:hover .g-card-idx{opacity:1}
        .g-card-pip{position:absolute;top:14px;left:14px;z-index:4;width:5px;height:5px;background:var(--olive-hi);transform:rotate(45deg);opacity:0;transition:opacity 0.35s ease}
        ...
        .g-lb-cat{font-size:8.5px;letter-spacing:0.28em;text-transform:uppercase;color:var(--olive-hi);margin-bottom:8px;display:block}
        ...
        .g-lb-btn:hover{border-color:var(--olive-hi);color:var(--olive-hi);background:rgba(138,158,74,0.04)}
        ...
        .g-btn--solid:hover{background:var(--gold-lt);border-color:var(--gold-lt);gap:20px;box-shadow:0 12px 36px rgba(138,158,74,0.06)}
        ...
        .g-foot{height:1px;background:rgba(0,0,0,0.04)}
